package com.example.microservice.card.dto;
...
public class CardsDto {
	...
	@Schema(description="Mobile Number of Customer",example="9012345678")
	...
	@Schema(description="Total available amount against a card",example="9000")
